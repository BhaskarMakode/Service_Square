      ...
      <div className="flex justify-between items-center max-w-7xl mx-auto px-6 h-full">
        ...
        <div className="flex items-center gap-4 relative">
          ...
          <div className="relative">
            ...
            >
              <img src="https://ui-avatars.com/api/?name=Guest+User&background=4F46E5&color=fff" className="w-8 h-8 rounded-xl shadow-sm" alt="User"/>
            ...
            {isUserMenuOpen && (
              <div className="absolute right-0 mt-3 w-64 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 overflow-hidden z-[999]">
                ...
                <div className="p-2 space-y-0.5">
                  <Link to="/dashboard" onClick={() => setIsUserMenuOpen(false)} className="flex items-center gap-3 px-3 py-2.5 text-sm font-bold text-slate-700 dark:text-slate-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-xl transition-all">
                ...
                <div className="p-2 border-t border-slate-50 dark:border-slate-700">
                  <Link to="/login" onClick={() => setIsUserMenuOpen(false)} className="flex items-center gap-3 px-3 py-2.5 text-sm font-bold text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-900/20 rounded-xl transition-all">
                    <span className="material-symbols-outlined text-lg">logout</span> Switch Account
                  </Link>
                </div>
              </div>
            )}
