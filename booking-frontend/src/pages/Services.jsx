      ...
      <aside className="hidden lg:flex flex-col w-72 shrink-0 gap-8">
        <div className="bg-surface-container-low p-6 rounded-3xl sticky top-28">
          ...
          <div className="space-y-8">
            ...
            <button className="w-full py-4 bg-indigo-600 text-white rounded-2xl font-bold shadow-xl shadow-indigo-200 hover:shadow-indigo-300 transition-all active:scale-[0.98]">
              Apply Filters
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          ...
          <div className="group bg-surface-container-lowest rounded-[2rem] p-4 shadow-sm hover:shadow-2xl hover:shadow-indigo-100/50 transition-all duration-500">
            <div className="relative overflow-hidden rounded-[1.5rem] mb-6">
              <img
                ...
                alt="Professional smiling male service provider portrait"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBPuJzPr39eRrso_TMGCiIwOE2ES1IV8Eqo6PCCr2a4i_rsxpIZLC5I9h9DXjWsSrwRMmwGwk0NGOdL7e5t3ODaHXkRhCqMFhX-MfHqD1rFarPVW0wFDPoFJ1C2NJ-Rf1An8j4lo9dvWmi2ZxvKj5crzfAgZtpalwN5wai2QTNxdgh_vc34LN_7VOJ9UMfgBgagCIid7ar6d2kPRojRcfmI7BGnIbT-HjttYw_RQwO0BTixnpk7UjPhwGxx4-nrGhm8YTgLOgc7_zg"
              />
            ...
            <div className="px-2 pb-2">
              ...
              <Link to="/booking" className="block w-full py-4 text-center bg-surface-container-low text-indigo-600 rounded-2xl font-bold hover:bg-primary hover:text-white transition-all duration-300">
                View Details
              </Link>
            </div>
          </div>
          ...
          <div className="group bg-surface-container-lowest rounded-[2rem] p-4 shadow-sm hover:shadow-2xl hover:shadow-indigo-100/50 transition-all duration-500">
            <div className="relative overflow-hidden rounded-[1.5rem] mb-6">
              <img
                className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-700"
                alt="Skilled male technician in uniform working"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAmAbQ4MFswYvq_Prw56Ao5RmfPU8DlASyk5PM3VyFk4xeGv7RGf_nBCAh6inSXNN9oJtNmZd8u5v-BXRKDiOMIoMHC5u57rDwgFc5hc2NF6ZMdVTGYZAaIS8JNwB332Y-_9OH3rLsDqVZ5CsFiT2uV3ra5NSVoTqwpvpFqgIvxQPlkblwLRHhZ_aopOi4L4zkjNZF9F-wjdTntDeoQDtRN4emG209FMQmg_yXpmcqpx4nJT8ImorHFRkl-9V2nPiqMmEW9NEJrNkk"
              />
              <div className="absolute top-4 right-4 backdrop-blur-md bg-white/40 px-4 py-1.5 rounded-full border border-white/40 flex items-center gap-1">
                <span className="material-symbols-outlined text-amber-400 text-lg" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
          ...
          <div className="group bg-surface-container-lowest rounded-[2rem] p-4 shadow-sm hover:shadow-2xl hover:shadow-indigo-100/50 transition-all duration-500">
            <div className="relative overflow-hidden rounded-[1.5rem] mb-6">
              <img
                className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-700"
                alt="HVAC technician working on ventilation"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAhzbaPtFCpYhUefIppwcpCjXyrcLuiijDGtVuuxaS8Qp4Po1yVBgvKeiTHa_-iRHC42eSdjjW0_VuIbxUAvA56IhsaEGhy5fQp_uz5yKZZr3ZHi_tL4UGhRLuvPyz2pzXe2LSMf8IGh3Ejpcp1av7Bv2av6Zbpmz7KYxQ5Lo12NbPqJlzANyBZ25suZQ5Tj7biDY8GMUaHqPO0NUdwuepgL4TrT6k7gl915RsHomcL_ZgHXoH801J48JoBOdrxGpjZ_q32tCieNSg"
              />
              <div className="absolute top-4 right-4 backdrop-blur-md bg-white/40 px-4 py-1.5 rounded-full border border-white/40 flex items-center gap-1">
                <span className="material-symbols-outlined text-amber-400 text-lg" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                <span className="text-sm font-bold text-slate-900">4.9</span>
